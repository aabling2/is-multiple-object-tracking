...
if __name__ == "__main__":
    ...
    # Carrega imagens
    img1 = cv2.imread('datasets/EPFL-RLC/multiclass_ground_truth_images/c3/00000001.jpg', 0)
    img2 = cv2.imread('datasets/EPFL-RLC/multiclass_ground_truth_images/c4/00000001.jpg', 0)
